demo = Person.create!(name: "Demo User", email: "demo_user@example.com", username: "demo_user", password: "password", company: "App Academy")
...
project = Project.create!(name: "Demo project", start_time: "2015-11-18 09:21:37 -0500", account_id: personal.id)
