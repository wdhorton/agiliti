...
var Simple = _reactAddons2['default'].createClass({
    displayName: 'Simple',
...
var TestComponent = _reactAddons2['default'].createClass({
    ...
    render: function render() {
        return _reactAddons2['default'].createElement(
            'div',
            { className: 'test' },
            _reactAddons2['default'].createElement(Simple, { id: '1', text: 'one' }),
            _reactAddons2['default'].createElement(Simple, { id: '2', text: 'two' })
        );
    }
...
describe('RenderedReactElementadapter', function () {
    ...
    beforeEach(function () {
        ...
        var renderedComponent = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(TestComponent, { className: 'foo' }));
    ...
    describe('text content', function () {
        ...
        beforeEach(function () {
            ...
            MultiContentComponent = _reactAddons2['default'].createClass({
            ...
            SingleContentComponent = _reactAddons2['default'].createClass({
            ...
            DualContentComponent = _reactAddons2['default'].createClass({
            ...
            MixedContentComponent = _reactAddons2['default'].createClass({
            ...
            var renderedComponent = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(MultiContentComponent, { count: 10 }));
            component = _reactRenderHook2['default'].findComponent(renderedComponent);
        });
        ...
        it('ignores content with null ', function () {
            ...
            var renderedComponent = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(MultiContentComponent, { count: null }));
            component = _reactRenderHook2['default'].findComponent(renderedComponent);
            var button = adapter.getChildren(component)[0];
            var children = adapter.getChildren(button);
        ...
        it('returns a single content item as the original type', function () {
            ...
            var component = _reactRenderHook2['default'].findComponent(TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(SingleContentComponent, { content: 42 })));
        ...
        it('returns the two content items as strings', function () {
            ...
            var component = _reactRenderHook2['default'].findComponent(TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(DualContentComponent, { content1: 42, content2: 43 })));
        ...
        it('returns the 2 content items in mixed children as strings', function () {
            ...
            var component = _reactRenderHook2['default'].findComponent(TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(MixedContentComponent, { content1: 42, content2: 43 })));
