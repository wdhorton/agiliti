...
test('should work with plain DOM node', function (t) {
  ...
  wrapElement(hook, React.createElement(
    'div',
    null,
    'Plain'
  ));
...
test('attaching late should work', function (t) {
  ...
  var node = document.createElement('div');
  React.render(React.createElement(SimpleApp, null), node);
...
test('should register two roots', function (t) {
  ...
  wrapRender(hook, function () {
    ...
    React.render(React.createElement(SimpleApp, null), node);
    React.render(React.createElement(SimpleApp, null), node2);
    React.unmountComponentAtNode(node);
...
test('State update', function (t) {
  ...
  wrapNode(function (node) {
    wrapRender(hook, function () {
      var App = React.render(React.createElement(StateApp, null), node);
...
test('Props update', function (t) {
  ...
  wrapNode(function (node) {
    wrapRender(hook, function () {
      var App = React.render(React.createElement(StateProps, null), node);
