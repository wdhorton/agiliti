...
var _diff4 = require('../diff');

var _diff5 = _interopRequireDefault(_diff4);
...
expect.addType({
    ...
    identify: function identify(value) {
        return value && value.name && value.attribs && value.children;
    },
...
expect.addAssertion('<TestHtmlLike> when diffed against <TestHtmlLike> <assertion>', function (expect, subject, value) {
...
expect.addAssertion('<TestHtmlLike> when diffed with options against <object> <TestHtmlLike> <assertion>', function (expect, subject, options, value) {
...
expect.addType({
    ...
    base: 'object',
    identify: function identify(value) {
        return value && value.output && typeof value.weight === 'number';
    }
});
...
expect.addAssertion('<HtmlDiffResult> to output with weight <string> <number>', function (expect, subject, value, weight) {
    expect.withError(function () {
        return expect(subject.output.toString(), 'to equal', value);
    }, function (e) {
        return expect.fail({
