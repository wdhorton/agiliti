...
expect.addAssertion('<object> to output <string>', function (expect, subject, result) {
    ...
    (0, _painter2['default'])(pen, subject, expect.inspect.bind(expect), expect.diff.bind(expect));
...
describe('Painter', function () {
    ...
    it('outputs a wrapper greyed out when the wrapper is not a diff', function () {
        ...
        expect(pen, 'to equal', expect.output.clone().gray('<div className="foo">').nl().indentLines().i().block(function () {
